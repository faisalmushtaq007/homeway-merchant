...
import 'package:homemakers_merchant/utils/same_types.dart';
...
/// locally using the package flutter_secure_storage:
/// https://pub.dev/packages/flutter_secure_storage
IOSOptions _getIOSOptions() => const IOSOptions(
      accountName: 'homemakers_merchant',
    );
...
class ThemeServicePrefs implements ThemeService {
  ...
  Future<T> load<T>(String key, T defaultValue) async {
    try {
      if (_debug) {
        debugPrint('SecureStorage has type .......... : $key '
            'as ${defaultValue.runtimeType}');
      }
      // T is boolean nullable value.
      if (sameTypes<T, bool?>()) {
        final int? value = (await _storage.read(
          key: key,
          aOptions: _getAndroidOptions(),
          iOptions: _getIOSOptions(),
        )) as int?;
        if (_debug) {
          debugPrint('SecureStorage loaded type bool?   : $key as $value');
          if (value == null) {
      ...
      if (sameTypes<T, int?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded type int?    : $key as $value');
        }
        // If value is null, we had no key for it, we should return the
        // default value, that may also be null, but it might not be too,
      ...
      if (sameTypes<T, double?>()) {
        final double? value = await _storage.read(
              key: key,
              aOptions: _getAndroidOptions(),
              iOptions: _getIOSOptions(),
            ) as double? ??
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded type double? : $key as $value');
        }
        if (value == null) return defaultValue;
      ...
      if (sameTypes<T, String?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded type String? : $key as $value');
        }
        if (value == null) return defaultValue;
      ...
      if (sameTypes<T, Color?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded Color?       : $key as $value');
        }
        // If value is null, we had no key for it, we should return the
        // default value, that may also be null, but it might not be too,
      ...
      if (sameTypes<T, ThemeMode?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded ThemeMode?   : $key as $value');
        }
        // If value is null, we had no key for it, we should return the
        // default value, that may also be null, but it might not be too,
      ...
      if (sameTypes<T, FlexScheme?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded FlexScheme?  : $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexSurfaceMode?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded FlexSurfaceMode? : $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexInputBorderType?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded FlexInputBorderType? : $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexAppBarStyle?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded FlexAppBarStyle? : $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexTabBarStyle?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded FlexTabBarStyle? : $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexSystemNavBarStyle?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded FlexSystemNavBarStyle? : $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, SchemeColor?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded SchemeColor? : $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, NavigationDestinationLabelBehavior?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded NavigationDestinationLabelBehavior? '
              ': $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, NavigationRailLabelType?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded NavigationRailLabelType?: $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, FlexSliderIndicatorType?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded FlexSliderIndicatorType?: $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, ShowValueIndicator?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded ShowValueIndicator?: $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, TabBarIndicatorSize?>()) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage loaded TabBarIndicatorSize?: $key as $value',
          );
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      if (sameTypes<T, AdaptiveTheme?>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage loaded AdaptiveTheme?: $key as $value');
        }
        if (value == null) return defaultValue;
        if (value < 0) return null as T;
      ...
      debugPrint('SecureStorage load ERROR');
    ...
    try {
      ...
      if (sameTypes<T, bool?>()) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint(
              'SecureStorage saved type bool? as int: $key NULL as $value',
            );
          }
          return;
        } else {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type bool? int: $key as $value');
          }
          return;
        }
      }
      ...
      if (sameTypes<T, bool>()) {
        ...
        if (_debug) {
          debugPrint('SecureStorage saved type bool as int : $key as $value');
        }
        return;
      }
      ...
      if (sameTypes<T, int?>()) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type int?     : $key NULL as -1');
          }
          return;
        } else {
          await _storage.write(
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type int?     : $key as $value');
          }
          return;
        }
      }
      ...
      if (sameTypes<T, double?>()) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type double?  : $key NULL as -1.0');
          }
          return;
        } else {
          await _storage.write(
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type double?  : $key as $value');
          }
          return;
        }
      }
      ...
      if (sameTypes<T, String?>()) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint(
              'SecureStorage saved type String?  : $key NULL as <NULL>',
            );
          }
          return;
        } else {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type String?  : $key as $value');
          }
          return;
        }
      }
      ...
      if (sameTypes<T, Color?>()) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type Color?   : $key NULL as -1');
          }
          return;
        } else {
          await _storage.write(
            key: key,
            value: '${(value as Color).value}',
            aOptions: _getAndroidOptions(),
            iOptions: _getIOSOptions(),
          );
          if (_debug) {
            debugPrint(
              'SecureStorage saved type Color?   : $key as ${value.value}',
            );
          }
          return;
        }
      ...
      if (value is Enum) {
        ...
        if (_debug) {
          debugPrint(
            'SecureStorage saved type Enum     : $key as ${value.index}',
          );
        }
        return;
      }
      ...
      if (value is Enum?) {
        if (value == null) {
          ...
          if (_debug) {
            debugPrint('SecureStorage saved type Enum?    : $key NULL as -1');
          }
          return;
        } else {
      ...
      debugPrint('SecureStorage save ERROR');
      debugPrint(' Error message ...... : $e');
      debugPrint(' Store key .......... : $key');
