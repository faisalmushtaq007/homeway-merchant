...
class AppStartConfig {
  ...
  Future<void> saveAllTempOrderData() async {
    ...
    final getAllOrderResult = await serviceLocator<GetAllOrderUseCase>()(
        (0, 10, null, OrderType.all, null, null, null, null));
    await getAllOrderResult.when(
      remote: (data, meta) {},
      localDb: (data, meta) async {
        if (data.isNotNull && data!.isNotEmpty) {
          ...
          final result =
              await serviceLocator<SaveAllOrderUseCase>()(data.toList());
