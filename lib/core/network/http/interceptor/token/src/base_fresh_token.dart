...
class OAuth2Token {
  ...
  const OAuth2Token({
    ...
    this.refreshToken,
    this.scope,
    this.scxOpenerpSessionId,
    this.enableStaticToken = false,
    this.staticAccessToken,
    this.enableScxOpenerpSessionId = true,
  });
  ...
  final String? scope;
  final String? scxOpenerpSessionId;
  final bool enableStaticToken;
  final String? staticAccessToken;
  final bool enableScxOpenerpSessionId;
}
