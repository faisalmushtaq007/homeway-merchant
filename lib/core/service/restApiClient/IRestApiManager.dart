...
/// The IRestApiManager class is an abstract class that defines a contract for managing network operations with models that
/// implement the INetworkModel interface.
abstract class IRestApiManager {
  ...
  Future<BaseResponseModel?> sendPrimitive(String path, {Map<String, dynamic>? headers});
}
