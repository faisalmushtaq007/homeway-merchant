...
class TodayOverAllOrderAnalysisState extends OrderAnalysisState{
  const TodayOverAllOrderAnalysisState({this.analysisBy=AnalysisBy.todayOrder});
  final AnalysisBy analysisBy;
  @override
  List<Object?> get props => [analysisBy];
}
class TodayOrderByStoreAnalysisState extends OrderAnalysisState{
  const TodayOrderByStoreAnalysisState({this.analysisBy=AnalysisBy.todayOrder});
  final AnalysisBy analysisBy;
  @override
  List<Object?> get props => [analysisBy];
}
class TodayOrderByOrderStatusAnalysisState extends OrderAnalysisState{
  const TodayOrderByOrderStatusAnalysisState({this.analysisBy=AnalysisBy.todayOrder});
  final AnalysisBy analysisBy;
  @override
  List<Object?> get props => [analysisBy];
}
class TodayOrderAnalysisProcessingState extends OrderAnalysisState{
  const TodayOrderAnalysisProcessingState({this.analysisBy=AnalysisBy.todayOrder,this.processing=false,});
  final AnalysisBy analysisBy;
...
class TodayOrderAnalysisFailedState extends OrderAnalysisState{
  const TodayOrderAnalysisFailedState({this.analysisBy=AnalysisBy.todayOrder,this.reason='',});
  final AnalysisBy analysisBy;
  final String reason;
  @override
  List<Object?> get props => [analysisBy];
...
class ByMonthlyOrderAnalysisState extends OrderAnalysisState{
  const ByMonthlyOrderAnalysisState({this.analysisBy=AnalysisBy.todayOrder,this.byMonth=1,});
  final AnalysisBy analysisBy;
  final int byMonth;
  @override
