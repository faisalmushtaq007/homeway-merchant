...
class WeeklyOrderAnalysisEvent extends OrderAnalysisEvent{
  const WeeklyOrderAnalysisEvent({this.analysisBy=AnalysisBy.todayOrder});
  final AnalysisBy analysisBy;
  @override
  List<Object?> get props => [analysisBy];
}
class ByMonthlyOrderAnalysisEvent extends OrderAnalysisEvent{
  const ByMonthlyOrderAnalysisEvent({this.analysisBy=AnalysisBy.todayOrder,this.byMonth=1,});
  final AnalysisBy analysisBy;
  final int byMonth;
  @override
