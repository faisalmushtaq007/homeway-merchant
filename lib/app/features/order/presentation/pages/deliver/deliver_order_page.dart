...
class AllDeliverOrderPage extends StatefulWidget {
  ...
  @override
  _AllDeliverOrderPageController createState() =>
      _AllDeliverOrderPageController();
}
...
class _AllDeliverOrderPageView
    extends WidgetView<AllDeliverOrderPage, _AllDeliverOrderPageController> {
