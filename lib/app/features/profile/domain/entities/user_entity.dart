...
class AppUserEntity extends INetworkModel<AppUserEntity> with AppEquatable {
  ...
  factory AppUserEntity.fromMap(Map<String, dynamic> map) {
    return AppUserEntity(
        ...
        currentProfileStatus:
            (map['currentProfileStatus'] != null) ? CurrentProfileStatus.values.byName(map['currentProfileStatus']) : CurrentProfileStatus.none,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'stores': this.stores.map((e) => e.toMap()).toList(),
      'token': this.token,
      ...
      'menus': this.menus.map((e) => e.toMap()).toList(),
      'drivers': this.drivers.map((e) => e.toMap()).toList(),
      ...
      'paymentBankEntities': this.paymentBankEntities.map((e) => e.toMap()).toList(),
