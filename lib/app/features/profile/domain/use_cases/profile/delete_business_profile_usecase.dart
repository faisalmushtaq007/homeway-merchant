...
class DeleteBusinessProfileUseCase
    extends UseCaseByID<BusinessProfileEntity, int, DataSourceState<bool>> {
  ...
  Future<DataSourceState<bool>> call(
    ...
    return userBusinessProfileRepository.deleteBusinessProfile(
