...
class SaveAllBusinessProfileUseCase extends UseCaseIO<List<BusinessProfileEntity>, DataSourceState<List<BusinessProfileEntity>>> {
  ...
  @override
  Future<DataSourceState<List<BusinessProfileEntity>>> call(List<BusinessProfileEntity> input) async {
