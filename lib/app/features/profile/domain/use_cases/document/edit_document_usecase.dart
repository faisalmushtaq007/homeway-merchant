...
class EditDocumentUseCase extends UseCaseByIDAndEntity<
  ...
  Future<DataSourceState<NewBusinessDocumentEntity>> call(
      {required NewBusinessDocumentEntity input, required int id}) async {
    return userBusinessDocumentRepository.editBusinessDocument(
