...
class GetAllDocumentPaginationUseCase extends PaginationQueryAllUseCaseIORecord<
    ...
    Timestamp?,
    Timestamp?,
    DataSourceState<List<NewBusinessDocumentEntity>>> {
  ...
  Future<DataSourceState<List<NewBusinessDocumentEntity>>> call({
    ...
    return await userBusinessDocumentRepository
