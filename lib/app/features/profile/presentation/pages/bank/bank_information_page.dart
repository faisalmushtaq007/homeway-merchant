                        ...
                        listener: (context, state) {
                          ...
                          if (state is GetPaymentBankState) {
                            _bankNameController.text =
                                state.paymentBankEntity?.bankName ?? '';
                            _accountNumberController.text =
                                state.paymentBankEntity?.accountNumber ?? '';
                            _confirmAccountNumberController.text =
                                state.paymentBankEntity?.accountNumber ?? '';
                            _accountHolderNameController.text =
                                state.paymentBankEntity?.bankHolderName ?? '';
                            _ibanNumberController.text =
                                state.paymentBankEntity?.ibanNumber ?? '';
                          }
                        },
