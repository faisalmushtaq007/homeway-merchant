...
class _BusinessDocumentPageState extends State<BusinessDocumentPage> {
  ...
  List<List<BusinessDocumentAssetsEntity>> all2DBusinessDocuments = [
    [],
    [],
    []
  ];
                          ...
                          builder: (context, state) {
                            state.maybeMap(
                              ...
                              addNewDocumentState: (value) {
                                ...
                                appLog.d(
                                    'BlocBuilder Data: ${allBusinessDocuments[index].documentFrontAssets?.assetOriginalName}');
                                appLog.d(
                                    'BlocBuilder Data value: ${allBusinessDocuments[0].documentFrontAssets?.assetName} - ${allBusinessDocuments[0].documentFrontAssets?.assetPath}');
                                allBusinessDocuments.insert(
                                  ...
                                  children: [
                                    ...
                                    AnimatedCrossFade(
                                      ...
                                      firstChild: Padding(
                                        ...
                                        child: ListTile(
                                          selected: true,
                                          selectedTileColor: Color.fromRGBO(220, 242, 228, 1),
                                          ...
                                          title: Text(
                                              allBusinessDocuments[index]
                                                  .documentFrontAssets
                                                  ?.assetName??'',style: context.labelMedium!.copyWith(color: Color.fromRGBO(42, 45, 50, 1.0)),),
                                          trailing: SizedBox(
                                            height: 26,
                                            width: 26,
                                      ...
                                      firstChild: ElevatedButton.icon(
                                        onPressed: () async {
                                          final List<dynamic>? result =
                                              await context.push<List<dynamic>>(
