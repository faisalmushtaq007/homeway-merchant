...
class SaveAllNotificationUseCase extends UseCaseIO<List<NotificationEntity>, DataSourceState<List<NotificationEntity>>> {
  ...
  @override
  Future<DataSourceState<List<NotificationEntity>>> call(List<NotificationEntity> input) async {
