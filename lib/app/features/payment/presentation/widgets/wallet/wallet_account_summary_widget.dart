...
class WalletAccountSummaryWidget extends StatefulWidget {
  ...
  @override
  _WalletAccountSummaryWidgetController createState() =>
      _WalletAccountSummaryWidgetController();
}

class _WalletAccountSummaryWidgetController
    extends State<WalletAccountSummaryWidget> {
  @override
  Widget build(BuildContext context) => _WalletAccountSummaryWidgetView(this);
}

class _WalletAccountSummaryWidgetView extends WidgetView<
    WalletAccountSummaryWidget, _WalletAccountSummaryWidgetController> {
    ...
    return Card(
      ...
      child: DecoratedBox(
        decoration: MatrixDecoration(
            radius: Radius.circular(10), backgroundColor: '#ffc300'.toColor),
        child: Padding(
