...
class IncomeTransactionWidget extends StatefulWidget {
  ...
  @override
  _IncomeTransactionWidgetController createState() =>
      _IncomeTransactionWidgetController();
}

class _IncomeTransactionWidgetController
    extends State<IncomeTransactionWidget> {
  @override
  Widget build(BuildContext context) => _IncomeTransactionWidgetView(this);
}

class _IncomeTransactionWidgetView extends WidgetView<IncomeTransactionWidget,
    _IncomeTransactionWidgetController> {
