...
class GetAllAppUserPaginationUseCase extends PaginationQueryAllUseCaseIORecord<AppUserEntity, int, int, String?,
    String?, String?, Timestamp?, Timestamp?, DataSourceState<List<AppUserEntity>>> {
