...
class _SaveStorePageState extends State<SaveStorePage> {
  ...
  void initState() {
    ...
    if (!widget.haveNewStore && widget.currentIndex != -1 && widget.storeEntity != null) {
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          ...
          body: BlocListener<BusinessProfileBloc, BusinessProfileState>(
            ...
            key: const Key('store-page-business-profile-bloc-listener'),
            listener: (context, businessProfileState) {
              if (businessProfileState is GetAllAppUserProfilePaginationState) {
                ...
                if (state is SaveStoreState) {
                  ...
                  if (widget.haveNewStore) {
                    userEnteredPhoneNumber =
                        appUserEntity?.phoneNumberWithoutDialCode ?? appUserEntity?.phoneNumber ?? '';
                    initialPhoneNumberValue = PhoneNumber(
                    ...
                    phoneNumberController.value = initialPhoneNumberValue;
                    defaultCountry = IsoCode.values.byName(appUserEntity?.isoCode ?? 'SA');
                    _storeAddressController.text =
                        appUserEntity?.businessProfile?.businessAddress?.address?.displayAddressName ?? '';
                    ...
                    if(cacheStore.isNotNull){
                      ...
                      userEnteredPhoneNumber =
                          cacheStore.phoneNumberWithoutDialCode ?? cacheStore.storePhoneNumber ?? '';
                      initialPhoneNumberValue = PhoneNumber(
                      ...
                      _storeAddressController.text = cacheStore.storeAddress?.address?.displayAddressName ?? '';
                      addressModel = cacheStore.storeAddress;
                      updateCategoryAndSubCategory(
                          cacheStore.storeCategories.last, cacheStore.storeCategories.last.subCategory.last);
                      listBanners = [];
                      listBanners.insert(
                        0,
                        BannerModel(
                      ...
                      _initialSelectedStoreAcceptedPaymentModes=[];
                      _initialSelectedWorkingDays=[];
                      if(cacheStore.storeOwnDeliveryPartnersInfo.isNotNullOrEmpty){
                        _hasStoreOwnDeliveryService=true;
                        _initialSelectedStoreOwnDrivers=List<StoreOwnDeliveryPartnersInfo>.from(cacheStore.storeOwnDeliveryPartnersInfo);
                      }
                      if(cacheStore.storeWorkingDays.isNotNullOrEmpty){
                        _initialSelectedWorkingDays=List<StoreWorkingDayAndTime>.from(cacheStore.storeWorkingDays);
                        _storeOpeningTimeController.text=cacheStore.storeOpeningTime??'';
                        _storeClosingTimeController.text=cacheStore.storeClosingTime??'';
                      }
                      if(cacheStore.storeAcceptedPaymentModes.isNotNullOrEmpty){
                        _initialSelectedStoreAcceptedPaymentModes=List<StoreAcceptedPaymentModes>.from(cacheStore.storeAcceptedPaymentModes);
                      }
                      _storeMaxDeliveryTimeController.text=cacheStore.storeMaximumFoodDeliveryTime.toString();
                      _maximumDeliveryRadiusValue=cacheStore.storeMaximumFoodDeliveryRadius.toDouble();
                    }
                                  ...
                                  Column(
                                    ...
                                    const AnimatedGap(12, duration: Duration(milliseconds: 500)),*/
                                      ...
                                      MultiSelectAvailableWorkingDaysFormField(
                                        ...
                                        initialSelectedAvailableWorkingDaysList: _initialSelectedWorkingDays.toList(),
                                        onSaved: (newValue) {},
                                      ),
                                      const AnimatedGap(12, duration: Duration(milliseconds: 500)),
                                      Text(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: StoreOwnDriverFormField(
                                                      ...
                                                      initialSelectedAvailableDriverList:
                                                          _initialSelectedStoreOwnDrivers.toList(),
                                                    ),
                                                  ),
                                                  const AnimatedGap(4, duration: Duration(milliseconds: 500)),
                                                  Padding(
                                                      ...
                                                      children: [
                                                        Expanded(
                                                          child: ElevatedButton.icon(
                                                            ...
                                                            icon: const Icon(
                                                              Icons.add,
                                                              color: Color.fromRGBO(42, 45, 48, 1),
                                                            ),
                                                            label: Text(
                                                              'Add Driver',
                                                            ...
                                                            onPressed: () async {
                                                              final List<StoreOwnDeliveryPartnersInfo>?
                                                                  returnSelectedDriver = await context
                                                                      .push<List<StoreOwnDeliveryPartnersInfo>>(
                                  ...
                                  child: SizedBox(),
                                      ...
                                      Wrap(
                                        ...
                                        children: [
                                          ...
                                          Tooltip(
                                            ...
                                            onTriggered: () {
                                              final dynamic tooltip = radiusTooTipKey.currentState;
                                      ...
                                      SliderTheme(
                                        data: SliderThemeData(
                                          ...
                                          valueIndicatorColor: const Color.fromRGBO(251, 219, 11, 1),
                                        ),
                                        child: Slider(
                                          min: 1,
                                          divisions: 19,
                                      ...
                                      MultiSelectAvailablePaymentModeFormField(
                                        ...
                                        initialSelectedAvailablePaymentModesList:
                                            _initialSelectedStoreAcceptedPaymentModes.toList(),
                                        onSaved: (newValue) {},
                                      ),
